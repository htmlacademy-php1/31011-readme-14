        ...
        <section class="authorization">
          ...
          <form class="authorization__form form" action="index.php" method="post">
            <div class="authorization__input-wrapper form__input-wrapper">
                ...
                <?php endif;?>
                    <input class="authorization__input authorization__input--login form__input" type="text" name="email" placeholder="E-mail" value="<?= (!empty($data_post['email'])) ? $data_post['email'] : ''; ?>">
                ...
                <?php endif;?>
                <span class="form__error-label form__error-label--login"><?= (!empty($errors['email']['text'])) ? $errors['email']['text'] : ''; ?></span>
            </div>
            ...
            <div class="authorization__input-wrapper form__input-wrapper">
                ...
                <?php endif;?>
                <span class="form__error-label"><?= (!empty($errors['password']['text'])) ? $errors['password']['text'] : ''; ?></span>
            </div>
